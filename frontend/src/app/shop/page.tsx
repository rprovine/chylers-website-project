...
async function getProducts() {
  ...
  return flavors.map((flavor, index) => ({
    ...
    variants: PRODUCT_CONFIG.packSizes.map((size, idx) => ({
      ...
      title: size.name,
      price: String(size.basePrice * size.quantity * (1 - (size.discount || 0))),
    ...
    images: [{
      id: String(index + 1),
      src: `https://images.unsplash.com/photo-${index % 2 === 0 ? '1599749183116-5b3b3f8c2f3f' : '1603048675767-6e79ff5b8fc7'}?w=800`,
